...
1.*If you need to add new geographic region:*
   ...
   2.Run dataflow_spatial_join.py in the opentechinstitute/SOTI. Some parameters need to be tweaked:
    ...
    2. Adding new data to the JSON file output in R:
	...
	1) To add a new data type to an existing set of geographic regions: 
	...
	2) To add a new geographic type:
...
3) Adding new data to the Mapbox map:
1) To add a new data type to an existing geographic type:
...
2)Adding new geometries to the map
